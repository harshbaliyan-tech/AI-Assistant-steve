...
def take_command():
    ...
    try:
        ...
        speak("Sorry I couldn't understand. can you repeat this again?")
        queri = 'None'
    return queri
...
if __name__ == '__main__':
    ...
    while True:
        if listening:
            ...
            if "how are you steve" in query:
                speak("I am absolutely fine sir. What about you")

            elif "hey steve" in query:
                speak("hello sir, tell me how may help you")


            elif "i am also fine" in query:
                speak("that's great sir")

            elif "thank you steve" in query:
                speak("Any time sir, tell me how may help you")
